...
namespace Pages.Model
{
    ...
    public class DetailsViewModel : INotifyPropertyChanged, IEquatable<DetailsViewModel>
    {
        ...
        private bool _morePostsDownloading;
        public bool MorePostsDownloading
        {
            get
            {
                return _morePostsDownloading;
            }
            set
            {
                _morePostsDownloading = value;
                NotifyPropertyChanged("MorePostsDownloading");
            }
        }
